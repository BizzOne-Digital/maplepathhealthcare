          ...
          <div className="relative bg-gradient-to-br from-[#1C3162] via-[#1E4A38] to-[#1A2F45] rounded-2xl px-14 py-16 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <a href="https://wa.me/19054675313" target="_blank" rel="noopener" className="inline-flex items-center gap-2 px-6 py-4 border-[1.5px] border-white/30 text-white rounded font-semibold text-[15px] hover:border-white/70 hover:bg-white/7 transition-all no-underline">
                  WhatsApp Us
                </a>
