...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.maplepathhealthcare.ca/reviews/' },
  openGraph: {
    title: 'Family Reviews — Maplepath Healthcare Halton | Real Care Stories',
    description: "Read real stories from Halton families — Oakville, Burlington, Milton, Georgetown — about Maplepath's PSW and home care services.",
    url: 'https://www.maplepathhealthcare.ca/reviews/',
  },
}
          ...
          <AnimateIn>
            <div className="bg-white rounded-2xl border border-[rgba(42,67,115,.1)] p-10 max-w-[700px] mx-auto text-center shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <a href="https://share.google/O6sOQHNuOxq97UnLJ" target="_blank" rel="noopener" className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#4285F4] text-white rounded font-bold hover:bg-[#3367D6] transition-all no-underline text-sm">
